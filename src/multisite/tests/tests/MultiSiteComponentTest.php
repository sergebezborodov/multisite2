...
class CustomMultiSite extends MultiSite {}

/**
 * Test case for multisite component
 */
class TestMultiSiteComponent extends \yii\test\TestCase
{

    protected function createMS()
    {
        $multisite = new Manager;
        ...
        $multisite->multisites = array(
            'main_site' => array(
                'id' => 1,
                'class' => 'multisite2\MultiSite',
                'units' => array(
                    'site' => 'one',
                    'platform' => 'web',
                ),
                'rule' => array('class' => 'multisite2\UrlRule', 'url' => 'site.ru'),
                'attributes' => array(
                    'attr1' => 'value1',
                    'attr2' => 'value2',
                ),
    ...
    public function testMultisites()
    {
        ...
        $this->assertInstanceOf('tests\CustomMultiSite', $multisite->multisites['second_site']);
    ...
    public function testMultisiteFind()
    {
        ...
        $this->assertInstanceOf('tests\CustomMultiSite', $inst2);
    }
    ...
    public function testBadUnits()
    {
        ...
        try {
            $units = $active->getUnits();
            $this->setExpectedException('multisite2\Exception');
        } catch (\Exception $e) {
            $this->assertInstanceOf('multisite2\Exception', $e);
        }
